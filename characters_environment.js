...
function startGame(){
  gameStatus = "start";
  document.getElementById("status").innerHTML = "Carregando Sua Sessao de Mario Impossible"
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("JEGUE, APERTA O BOTAO SE QUISER JOGAR ANTA", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("'Pensamentos inteligentes estao sempre atras de voce So que voce e o flash'", gameConfig.screenX/2, gameConfig.screenY/2+105);
    textSize(15);
